...
public class MDFileInputStream extends MDInputStream implements AutoCloseable {

    private final RandomAccessFile file;

     public MDFileInputStream(@NotNull final String filename) throws FileNotFoundException {
